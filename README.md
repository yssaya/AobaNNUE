...
振電3を抜いて最強だと思います。
振電3より +30 ELO 程度強いです。振電3付属のWindowだと +67 ELO強いです。
...
# ソースの変更点
  ...
  標準NNUE(HalfKP_256x2_32_32)ではなく HalfKP_768_x2_16_64 を採用。
...
# 評価関数の作成
  ...
  2025年選手権版のAobaZeroの0手読みの評価値で上書きしたでしたデータで学習させています。
  ...
  [https://github.com/TadaoYamaoka/DeepLearningShogi/blob/master/dlshogi/utils/hcpe_re_eval.py](https://github.com/TadaoYamaoka/DeepLearningShogi/blob/master/dlshogi/utils/hcpe_re_eval.py)
...
# 棋力の検証
  ...
  Linux(ubuntu 24.04)での比較
    ...
    振伝3を7.70で動かすと+68とほぼWindows版と同じ結果でした。
    ...
    1248-72-1080 2400 (0-72-5)(1215-1113,0.522), 0.535(0.020)(  24) 0.1秒/手(約  75万/手) 
     449-58- 293  800 (1-58-2)( 424- 318,0.571), 0.598(0.033)(  68) 0.1秒/手, 振伝3は7.70kaiのソース 
